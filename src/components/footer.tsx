        ...
        <footer ref={ref} style={{animation: hasAnimated ? 'fadeInUp 0.6s ease-out forwards' : 'none'}}>
            ...
            <div className="w-full bg-neutral-950 py-6">
                <div className="py-8 px-16 max-[500px]:px-2">
                    <div className="grid grid-cols-3 gap-x-8 gap-y-8 max-lg:grid-cols-1">
                        <div className="flex flex-col justify-center items-start max-lg:items-center max-lg:justify-center group">
                        ...
                        <div className="flex flex-col justify-start items-center gap-2">
                            ...
                            <div className="flex flex-col gap-1 text-sm text-neutral-200 px-9 text-right max-lg:text-center group">
